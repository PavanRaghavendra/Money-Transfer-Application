    ...
    <div className="flex flex-col justify-center">
        <div className=" bg-white w-80 h-max rounded-md p-2 text-center px-4">
           ...
           <form className="flex flex-col pb-3">
            ...
            <input  id="email"placeholder="jondoe@example.com" className="rounded-sm p-2 broder-black-500 w-full hover:bg-slate-400"/>
            <label className="text-left pt-2 pb-1 pl-1 font-semibold">Password</label>
            <input className="rounded-sm p-2  broder-black-500 w-full hover:bg-slate-400"></input>
            </form>
            <button className="bg-black text-white w-full rounded-sm p-2 font-semibold hover:bg-gray-700">Sign in</button>
            <div className="flex flex-row justify-center mb-4 mt-2">
            <p>Don't have an account?</p>
            <Link to={"/Signup"} className="underline cursor-pointer" preventScrollReset={true}>Sign Up</Link>
            </div>
        </div>
        </div>
    </div>
